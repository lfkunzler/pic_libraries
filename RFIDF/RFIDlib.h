...
#define MFRC522_NSS PORTBbits.RB2  //

#define MFRC522_SCK PORTBbits.RB1 //saida  SCK

#define MFRC522_SI  PORTBbits.RB0  //saida   MOSI                

#define MFRC522_SO  PORTCbits.RC7 // entrada    MISO         

#define MFRC522_RST PORTBbits.RB3 // saida  RST
...
unsigned int MFRC522_Rd(unsigned int Address)
 {
